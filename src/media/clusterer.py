"""
Clustering module for assigning media files to clusters based on embeddings.

Uses cosine similarity with cluster centroids to assign files to existing clusters
or create new provisional clusters.
"""
...
class ClusteringError(Exception):
    """Exception raised during clustering."""
    pass
...
class MediaClusterer:
    ...
    Assigns files to existing clusters or creates new provisional clusters.
    """
    ...
    def find_best_cluster(
        ...
        Args:
            ...
            threshold: Similarity threshold (defaults to cluster threshold)
            
        Returns:
            Tuple of (cluster_id, similarity) if match found, None otherwise
        """
    ...
    def update_cluster_centroid(
        ...
        if cluster.centroid is None:
            ...
            new_centroid = (current_centroid * asset_count + new_embedding) / (asset_count + 1)
